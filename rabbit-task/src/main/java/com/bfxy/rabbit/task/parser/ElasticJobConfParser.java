...
public class ElasticJobConfParser implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private JobZookeeperProperties mJobZookeeperProperties;

    private ZookeeperRegistryCenter mZookeeperRegistryCenter;
    ...
    public ElasticJobConfParser(JobZookeeperProperties jobZookeeperProperties, ZookeeperRegistryCenter zookeeperRegistryCenter) {
        this.mJobZookeeperProperties = jobZookeeperProperties;
        this.mZookeeperRegistryCenter = zookeeperRegistryCenter;
    }
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        try {
            ...
            for (Iterator<?> it = beanMap.values().iterator(); it.hasNext(); ) {
                ...
                String jobName = this.mJobZookeeperProperties.getNamespace() + "." + conf.name();
                ...
                //	2.添加注册中心
                factory.addConstructorArgValue(this.mZookeeperRegistryCenter);
